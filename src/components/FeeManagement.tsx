          ...
          <Card className="p-2">
            <div className="flex gap-2">
              <button style={{ border: '1px solid blueviolet' }}
                ...
                className={`flex-1 px-6 py-3 rounded-lg font-semibold transition-all cursor-pointer ${activeTab === 'overview'
              ...
              <button style={{ border: '1px solid blueviolet' }}
                ...
                className={`flex-1 px-6 py-3 rounded-lg font-semibold transition-all cursor-pointer ${activeTab === 'pending'
              ...
              <button style={{ border: '1px solid blueviolet' }}
                ...
                className={`flex-1 px-6 py-3 rounded-lg font-semibold transition-all cursor-pointer ${activeTab === 'feeDetails'
