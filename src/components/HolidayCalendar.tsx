  ...
  const renderCalendar = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      days.push(
        <div
          key={day}
          className={`aspect-square p-1 sm:p-2 border border-gray-200 rounded-lg relative ${holiday ? 'bg-amber-50 border-amber-300' : 'bg-white'
        ...
        >
          ...
          {holiday && (
            <div className="mt-1">
              ...
              <Badge
                variant="outline"
                className={`mt-1 text-[6px] sm:text-[8px] px-1 py-0 h-auto ${holiday.type === 'Public Holiday'
    ...
    <>
      ...
      <>
        ...
        <motion.div
          ...
          className="inset-4 sm:inset-auto sm:left-1/2 sm:top-1/2 sm:w-[95%] sm:max-w-5xl sm:max-h-[90vh] "
        >
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <Badge
                              variant="outline"
                              className={`mt-2 text-xs ${holiday.type === 'Public Holiday'
