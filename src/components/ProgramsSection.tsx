...
export function ProgramsSection() {
  ...
  return (
    <section className="relative">
      {/* Top Half - Blue Header */}
      <div className="bg-[#2563EB] pb-36 relative overflow-hidden">
        {/* Decorative circles */}
        <div className="absolute right-24 bottom-0 w-72 h-72 bg-white/5 rounded-full blur-3xl"></div>
        <div className="absolute left-24 top-0 w-52 h-52 bg-white/5 rounded-full blur-3xl"></div>
      ...
      <div className="bg-[#F5F1E8] py-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:max-w-6xl">
          {/* Program Cards Grid — pulled up into the blue section */}
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex cursor-pointer items-center gap-2 text-gray-700 text-base font-semibold hover:gap-4 transition-all"
              onClick={() => navigate('/apply')}
            >
