    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="w-24 h-1 bg-[#2563EB] mx-auto mt-6 rounded-full"></div>
          </motion.div>

          {/* Connector line behind cards */}
          <div className="relative max-w-6xl mx-auto">
            <div className="hidden md:block absolute top-[52px] left-[10%] right-[10%] h-0.5 bg-gradient-to-r from-blue-200 via-blue-400 to-blue-200 z-0" />

            <div className="grid md:grid-cols-5 gap-6">
              {steps.map((step, index) => {
                const cardColors = [
                  { bg: "bg-blue-600", light: "bg-blue-50", border: "border-blue-200", text: "text-blue-600" },
                  { bg: "bg-violet-600", light: "bg-violet-50", border: "border-violet-200", text: "text-violet-600" },
                  ...
                  { bg: "bg-rose-600", light: "bg-rose-50", border: "border-rose-200", text: "text-rose-600" },
                ];
                ...
                return (
                  ...
                  >
                    {/* Step number badge */}
                    <div className={`w-10 h-10 ${color.bg} rounded-full flex items-center justify-center text-sm font-bold text-white shadow-lg mb-[-20px] z-20 border-4 border-white`}>
                      {index + 1}
                    </div>

                    {/* Card */}
                    <div className={`w-full pt-10 pb-6 px-5 text-center rounded-2xl border-2 ${color.border} ${color.light} shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1`}>
                      <div className={`w-14 h-14 ${color.bg} rounded-xl flex items-center justify-center mx-auto mb-4 shadow-md`}>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="bg-[#F5F1E8] py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            {/* Program Cards Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-6 -mt-48">
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="flex gap-2.5">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="flex-1 cursor-pointer bg-white hover:bg-gray-50 text-[#2563EB] border-2 border-[#2563EB] py-2 px-4 rounded-full font-medium transition-colors text-sm"
                    >
                      Read More..
                    </motion.button>
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="flex-1 cursor-pointer bg-[#2563EB] hover:bg-[#1e40af] text-white py-2 px-4 rounded-full font-medium transition-colors text-sm flex items-center justify-center gap-1"
                    >
                      Apply Now
                    </motion.button>
                  </div>
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="flex gap-2.5">
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="flex-1 bg-white cursor-pointer hover:bg-gray-50 text-[#2563EB] border-2 border-[#2563EB] py-2 px-4 rounded-full font-medium transition-colors text-sm"
                    >
                      Read More
                    </motion.button>
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="flex-1 bg-[#2563EB] cursor-pointer hover:bg-[#1e40af] text-white py-2 px-4 rounded-full font-medium transition-colors text-sm flex items-center justify-center gap-1"
                    >
                      Apply Now
                      <span className="text-base">→</span>
                    </motion.button>
