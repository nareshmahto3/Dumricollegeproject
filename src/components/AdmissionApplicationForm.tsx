...
const jciLogo = new URL('../assets/jci_logo.png', import.meta.url).href;
...
export function AdmissionApplicationForm() {
  ...
  const handleSubmit = async () => {
    if (!isDeclared) {
      toast.error('Please read and accept the declaration to proceed');
      return;
    }
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex flex-col overflow-hidden">
      ...
      <motion.div 
        ...
        className="bg-white/90 border-b shadow-sm z-50 backdrop-blur-lg flex-shrink-0"
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="h-14 w-24 sm:h-16 sm:w-35 rounded-xl bg-white shadow-md ring-1 ring-blue-100 flex items-center justify-center overflow-hidden">
                <img
                  src={jciLogo}
                  alt="JCIC Dumri Logo"
              ...
              <div className="p-8">
                ...
                {currentStep === 7 && (
                  <ReviewDashboard
                    ...
                    onDeclaredChange={setIsDeclared}
                        ...
                        {currentStep < 7 ? (
                          ...
                          >
                            ...
                            >
                              ...
                              {isSubmitting ? 'Submitting...' : isDeclared ? 'Submit Application' : 'Accept Declaration to Submit'}
                            </Button>
                          </motion.div>
                        )}
                      </>
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ReviewField label="Class" value={className} required />
        ...
        <motion.div
          ...
          transition={{ delay: 0.5 }}
        >
          <Card className="p-6 bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-300 rounded-2xl">
            <div className="flex gap-4">
              <div className="flex items-start pt-1">
                <input
                  type="checkbox"
                  checked={isDeclared}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => onDeclaredChange(e.target.checked)}
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-amber-800 leading-relaxed">
                  I hereby declare that the information provided in this application form is true, complete, and correct to the best of my knowledge and belief. I understand that any false or misleading information shall lead to rejection of my application or expulsion from the institution if discovered later. I accept all the terms and conditions specified by Dumri College for admission.
                </p>
                <div className="mt-4 flex items-center gap-2">
                  {isDeclared ? (
                    <div className="flex items-center gap-2 text-green-600">
                      <Check className="w-5 h-5" />
                      <span className="text-sm font-semibold">Declaration accepted</span>
                    </div>
                  ) : (
                    <div className="flex items-center gap-2 text-red-600">
                      <AlertCircle className="w-5 h-5" />
                      <span className="text-sm font-semibold">Please accept the declaration to proceed</span>
                    </div>
                  )}
                </div>
              </div>
        ...
        {!isDeclared && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="p-4 bg-blue-50 border-l-4 border-blue-500 rounded text-sm text-blue-700"
          >
            <div className="flex items-start gap-2">
              <AlertCircle className="w-5 h-5 flex-shrink-0 mt-0.5" />
              <p>Please read and accept the declaration above before submitting your application.</p>
            </div>
          </motion.div>
        )}
      </div>
